...
namespace TurkogluTugla.KullanıcıArayuzu
{
    public partial class Müşteriler : Form
    {
        ...
        tekrar:
            ...
            {
                bool b = islem.MüşteriEkle(frmMusteri.Musteri);

                if (b)
                {

                    DataSet ds = islem.MüşteriGetir("");
                    if (ds != null)
        ...
        private void btnMüşteriDüzenle_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = islem.MüşteriGüncelle(frmMusteri.Musteri);
        ...
        {
            DataSet ds = islem.MüşteriGetir(toolStripTextBox1.Text);
            if (ds != null)
                dataGridView1.DataSource = ds.Tables[0];
        ...
        {
            DataSet ds1 = islem.MüşteriGetir("");
            if (ds1 != null)
