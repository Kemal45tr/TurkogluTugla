...
namespace TurkogluTugla.KullanıcıArayuzu
{
    public partial class Ürünler : Form
    {
        ...
        private void btnÜrünEkle_Click(object sender, EventArgs e)
        {
            ...
            MalzemelerFormu frm = new MalzemelerFormu()
            {
                Text = "Ürün Ekle",
        ...
        tekrar:
            ...
            {
                bool b = islem.UrunEkle(frm.Urun);

                if (b)
                {

                    DataSet ds = islem.UrunGetir("");
                    if (ds != null)
        ...
        {
            DataSet ds = islem.UrunGetir(toolStripTextBox2.Text);
            if (ds != null)
                dataGridView2.DataSource = ds.Tables[0];
        }
        ...
        private void btnÜrünDüzenle_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = islem.UrunGüncelle(frm.Urun);
